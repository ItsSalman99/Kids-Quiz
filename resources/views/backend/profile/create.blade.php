        ...
        <div class="container" style="margin-bottom: 100px;">
            <div class="multisteps_form position-relative overflow-hidden mt-5">
                ...
                <div class="form_header_content text-center pt-4">
                    ...
                    <span>You can update your profile from here!</span>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12" style="margin-bottom: 30px;">
                                <div class="form-group">
                                    ...
                                    <textarea name="info" id="" cols="30" rows="10" class="form-control">{{ Auth::user()->profile_info }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form_btn py-5 text-center">
                            <button type="submit" class="f_btn active text-uppercase rounded-pill text-white">
                                Save
