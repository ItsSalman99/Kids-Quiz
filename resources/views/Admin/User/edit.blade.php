                        ...
                        <div class="border p-4 rounded">
                            ...
                            <form action="{{route('admin.user.update')}}" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" value="{{old('name',$user->name)}}" name="name" class="form-control  @error('name') is-invalid @enderror" id="inputFirstName" placeholder="Enter Your Name">
                                        @error('name')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="email" value="{{old('email',$user->email)}}" name="email" class="form-control  @error('email') is-invalid @enderror" id="inputEmailAddress" placeholder="example@user.com">
                                        @error('email')
                                        <div class="invalid-feedback">{{$message}}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="invalid-feedback">{{$message}}</div>
                                        @enderror
                                        <img src="{{asset('storage/profile/'.$user->user_img)}}" alt="" class="mt-2" height="70px" width="60px">
                                    </div>
                                </div>
